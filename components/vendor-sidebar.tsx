...
import { LayoutDashboard, ShoppingBag, Calendar, MessageSquare, Settings, LogOut, Menu, X, Star } from 'lucide-react'
import { useState } from 'react'

const navigationItems = [
  { icon: LayoutDashboard, label: 'Dashboard', href: '/vendor/dashboard' },
  { icon: ShoppingBag, label: 'Services', href: '/vendor/services' },
    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-b border-sidebar-border">
          <Link href="/vendor/dashboard" className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
